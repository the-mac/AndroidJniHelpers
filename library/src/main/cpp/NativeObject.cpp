...
NativeObject::NativeObject(JNIEnv *env) : JavaClass(env) {}//{ initialize(env); } //
NativeObject::~NativeObject() {}


//const char *NativeObject::getCanonicalName() const { return NULL; }
//
//void NativeObject::initialize(JNIEnv *env) {}
