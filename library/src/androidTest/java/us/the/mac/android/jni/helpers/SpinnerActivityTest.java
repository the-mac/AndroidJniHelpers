...
import us.the.mac.android.jni.helpers.SpinnerActivity;
...
public class SpinnerActivityTest extends ActivityInstrumentationTestCase2<SpinnerActivity> {
    ...
    public SpinnerActivityTest() {
        super("us.the.mac.android.jni.helpers", SpinnerActivity.class);
    }
    ...
    protected void setUp() throws Exception {
        ...
        mSpinner = (Spinner)mActivity.findViewById(us.the.mac.android.jni.helpers.R.id.Spinner01);
    ...
    public void testSpinnerUI() {
        ...
        TextView resultView =
                (TextView) mActivity.findViewById(us.the.mac.android.jni.helpers.R.id.SpinnerResult);
