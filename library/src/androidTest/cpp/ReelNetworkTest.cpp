...
void ReelNetworkTest::initialize(JNIEnv *env) {
    setClass(env);
...
jobject ReelNetworkTest::createNetwork(JNIEnv *env, jobject javaThis) {
...
jobject ReelNetworkTest::getPersistedInstance(JNIEnv *env, jobject javaThis, jobject object) {
...
void ReelNetworkTest::nativeIsPersistenceEnabled(JNIEnv *env, jobject javaThis) {
...
void ReelNetworkTest::isPersistenceEnabledWithoutInit(JNIEnv *env, jobject javaThis) {
    Network network;
    JUNIT_ASSERT_FALSE(network.isInitialized());
}

void ReelNetworkTest::destroyNetwork(JNIEnv *env, jobject javaThis, jobject object) {
...
void ReelNetworkTest::persistNullObject(JNIEnv *env, jobject javaThis) {
...
void ReelNetworkTest::nativeGetPutAndToJSONString(JNIEnv *env, jobject javaThis) {
...
void ReelNetworkTest::nativeNetworkRequest(JNIEnv *env, jobject javaThis) {
...
void ReelNetworkTest::destroyInvalidClass(JNIEnv *env, jobject javaThis) {
...
void ReelNetworkTest::destroyNullObject(JNIEnv *env, jobject javaThis) {
